...
const DISTRICTS_HCM = [
  ...
  "Thủ Đức", "Bình Thạnh", "Bình Tân", "Tân Bình",
];
...
export default function StudentDashboard() {
  ...
  const normalizeDate = (value: string) => {
    ...
    // input[type=date] -> yyyy-MM-dd, giữ nguyên
    return value;
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-[#5e1f12] to-[#3b0c12] text-orange-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6 space-y-6">
        ...
        {/* Tiles nhanh – 2 hàng, nhiều ô cho HS dùng */}
        ...
        {/* Chỗ này bạn có thể code thêm: danh sách lớp, tiến độ, v.v. */}
      </main>
    </div>
  );
}
