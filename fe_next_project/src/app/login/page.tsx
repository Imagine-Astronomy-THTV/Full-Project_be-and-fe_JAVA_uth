export default function LoginPage() {
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-100 to-orange-200 overflow-hidden">
...
<div className="absolute w-24 h-24 bg-white rounded-full opacity-80 top-1/3 right-1/3 blur-md shadow-[0_0_30px_rgba(255,255,255,0.9)]"></div>
      ...
      <div className="relative z-10 bg-white p-10 rounded-3xl shadow-2xl w-full max-w-md text-center transform transition-all duration-300 hover:shadow-orange-200">
        {/* Tiêu đề */}
        <h1 className="text-4xl font-extrabold text-orange-700 mb-6 tracking-wide">
        ...
        <form className="space-y-5 text-left">
          <div>
            ...
            <input
              ...
              className="w-full border border-orange-300 rounded-lg px-3 py-2 text-gray-900 placeholder:text-gray-500 placeholder:font-medium focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400 hover:border-orange-400 transition duration-200"
              required
            />
          </div>
        ...
        <div className="text-center mt-6 text-sm">
          <a href="/register" className="text-orange-600 font-medium hover:underline hover:text-orange-700 transition">
